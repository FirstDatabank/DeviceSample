...
namespace DeviceSample.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class StorageHandling :  IEquatable<StorageHandling>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="StorageHandling" /> class.
        /// </summary>
        ...
        public StorageHandling(string StorageHandlingType = default(string), string StorageLowValue = default(string), string StorageLowValueUnit = default(string), string StorageHighValue = default(string), string StorageHighValueUnit = default(string), string StorageSpecialCondition = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class StorageHandling {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as StorageHandling);
        }

        /// <summary>
        /// Returns true if StorageHandling instances are equal
        /// </summary>
        /// <param name="other">Instance of StorageHandling to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StorageHandling other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
