...
namespace DeviceSample.Model
{
    ...
    public partial class Device : IEquatable<Device>
    {
        ...
        /// </summary>
        /// <param name="PrizmId">Returns the FDB identifier of the device record in the Prizm database.</param>
        /// <param name="StandardDeviceName">Returns a normalized name of the device using descriptive text.</param>
        /// <param name="EnhancedDeviceName">Returns a more descriptive name for a device composed of the labeler name, brand name (if it exists), standard device name and relevant sizes.</param>
        /// <param name="EnhancedDeviceNameLong">Returns an even more descriptive name for a device composed of the labeler name, brand name (if it exists), standard device name, relevant sizes and other properties such at materials, shapes, colors, etc..</param>
        ...
        /// <param name="GTIN14">Returns the fourteen digit Global Trade Identification Number assigned by GS1 for the device.</param>
        /// <param name="HIBC">Returns the Healthcare Industry Bar Code assigned by HIBCC for the device.</param>
        ...
        /// <param name="GUDIDVersionModelNumber">Returns the GUDID version or model number of the device.</param>
        ...
        /// <param name="BasePackageType">Returns the description of the type of the base package; e.g. box, carton, case, etc..</param>
        /// <param name="BasePackageTypeCode">Returns the ANSI formatted code for the base package type code; e.g. BX, CT, CA, etc..</param>
        ...
        /// <param name="LotNumberControlCode">Returns the lot number control code indicating whether or not the device has a lot number associated with it. Possible values are 1 - true/yes, 0 - false/no, -1 - Unknown.</param>
        /// <param name="SerialNumberControlCode">Returns the serial number control code indicating whether or not the device has a serial number associated with it. Possible values are 1 - true/yes, 0 - false/no, -1 - Unknown.</param>
        /// <param name="ExpirationDateControlCode">Returns the expiration date control code indicating whether or not the device has an expiration date associated with it. Possible values are 1 - true/yes, 0 - false/no, -1 - Unknown.</param>
        /// <param name="ManufacturedDateControlCode">Returns the manufactured date control code indicating whether or not the device has a manufactured date associated with it. Possible values are 1 - true/yes, 0 - false/no, -1 - Unknown.</param>
        /// <param name="DonationIdNumberControlCode">Returns the donation id number control code indicating whether or not the device has a donation number associated with it (e.g. for tissue donations). Possible values are 1 - true/yes, 0 - false/no, -1 - Unknown.</param>
        ...
        /// <param name="LabelerContactInfo">Returns contact information for the labeler of the device.</param>
        /// <param name="UDIDIPublishDate">Returns the date the device record with the UDI was published in the GUDID (Global Unique Device Identifier Database); format: datetime.</param>
        /// <param name="PrizmPublishDate">Returns the date the device record was first published in the Prizm Medical Device Knowledge Base; format: datetime.</param>
        /// <param name="PrizmRevisionDate">Returns the last date the device record was updated and republished in the Prizm Medical Device Knowledge Base; format: datetime.</param>
        ...
        /// <param name="HCPCSInfo">Returns the HCPCS information for the device, if it is available and appropriate..</param>
        ...
        /// <param name="DeviceProperties">Returns device properties such at materials, shapes, colors, etc..</param>
        /// <param name="LabelerAliases">Returns a list of labeler aliases.</param>
        /// <param name="AlternateDeviceNames">Alternate device names.</param>
        ...
        /// <summary>
        /// Returns the FDB identifier of the device record in the Prizm database
        /// </summary>
        /// <value>Returns the FDB identifier of the device record in the Prizm database</value>
        [DataMember(Name = "PrizmId", EmitDefaultValue = false)]
        public int? PrizmId { get; set; }
        /// <summary>
        /// Returns a normalized name of the device using descriptive text
        /// </summary>
        /// <value>Returns a normalized name of the device using descriptive text</value>
        [DataMember(Name = "StandardDeviceName", EmitDefaultValue = false)]
        public string StandardDeviceName { get; set; }
        /// <summary>
        /// Returns a more descriptive name for a device composed of the labeler name, brand name (if it exists), standard device name and relevant sizes
        /// </summary>
        /// <value>Returns a more descriptive name for a device composed of the labeler name, brand name (if it exists), standard device name and relevant sizes</value>
        [DataMember(Name = "EnhancedDeviceName", EmitDefaultValue = false)]
        public string EnhancedDeviceName { get; set; }
        /// <summary>
        /// Returns an even more descriptive name for a device composed of the labeler name, brand name (if it exists), standard device name, relevant sizes and other properties such at materials, shapes, colors, etc.
        /// </summary>
        /// <value>Returns an even more descriptive name for a device composed of the labeler name, brand name (if it exists), standard device name, relevant sizes and other properties such at materials, shapes, colors, etc.</value>
        ...
        /// <summary>
        /// Returns the fourteen digit Global Trade Identification Number assigned by GS1 for the device
        /// </summary>
        /// <value>Returns the fourteen digit Global Trade Identification Number assigned by GS1 for the device</value>
        [DataMember(Name = "GTIN_14", EmitDefaultValue = false)]
        public string GTIN14 { get; set; }
        /// <summary>
        /// Returns the Healthcare Industry Bar Code assigned by HIBCC for the device
        /// </summary>
        /// <value>Returns the Healthcare Industry Bar Code assigned by HIBCC for the device</value>
        ...
        /// <summary>
        /// Returns the GUDID version or model number of the device
        /// </summary>
        /// <value>Returns the GUDID version or model number of the device</value>
        ...
        /// <summary>
        /// Returns the description of the type of the base package; e.g. box, carton, case, etc.
        /// </summary>
        /// <value>Returns the description of the type of the base package; e.g. box, carton, case, etc.</value>
        [DataMember(Name = "BasePackageType", EmitDefaultValue = false)]
        public string BasePackageType { get; set; }
        /// <summary>
        /// Returns the ANSI formatted code for the base package type code; e.g. BX, CT, CA, etc.
        /// </summary>
        /// <value>Returns the ANSI formatted code for the base package type code; e.g. BX, CT, CA, etc.</value>
        ...
        /// <summary>
        /// Returns the lot number control code indicating whether or not the device has a lot number associated with it. Possible values are 1 - true/yes, 0 - false/no, -1 - Unknown
        /// </summary>
        /// <value>Returns the lot number control code indicating whether or not the device has a lot number associated with it. Possible values are 1 - true/yes, 0 - false/no, -1 - Unknown</value>
        [DataMember(Name = "LotNumberControlCode", EmitDefaultValue = false)]
        public int? LotNumberControlCode { get; set; }
        /// <summary>
        /// Returns the serial number control code indicating whether or not the device has a serial number associated with it. Possible values are 1 - true/yes, 0 - false/no, -1 - Unknown
        /// </summary>
        /// <value>Returns the serial number control code indicating whether or not the device has a serial number associated with it. Possible values are 1 - true/yes, 0 - false/no, -1 - Unknown</value>
        [DataMember(Name = "SerialNumberControlCode", EmitDefaultValue = false)]
        public int? SerialNumberControlCode { get; set; }
        /// <summary>
        /// Returns the expiration date control code indicating whether or not the device has an expiration date associated with it. Possible values are 1 - true/yes, 0 - false/no, -1 - Unknown
        /// </summary>
        /// <value>Returns the expiration date control code indicating whether or not the device has an expiration date associated with it. Possible values are 1 - true/yes, 0 - false/no, -1 - Unknown</value>
        [DataMember(Name = "ExpirationDateControlCode", EmitDefaultValue = false)]
        public int? ExpirationDateControlCode { get; set; }
        /// <summary>
        /// Returns the manufactured date control code indicating whether or not the device has a manufactured date associated with it. Possible values are 1 - true/yes, 0 - false/no, -1 - Unknown
        /// </summary>
        /// <value>Returns the manufactured date control code indicating whether or not the device has a manufactured date associated with it. Possible values are 1 - true/yes, 0 - false/no, -1 - Unknown</value>
        [DataMember(Name = "ManufacturedDateControlCode", EmitDefaultValue = false)]
        public int? ManufacturedDateControlCode { get; set; }
        /// <summary>
        /// Returns the donation id number control code indicating whether or not the device has a donation number associated with it (e.g. for tissue donations). Possible values are 1 - true/yes, 0 - false/no, -1 - Unknown
        /// </summary>
        /// <value>Returns the donation id number control code indicating whether or not the device has a donation number associated with it (e.g. for tissue donations). Possible values are 1 - true/yes, 0 - false/no, -1 - Unknown</value>
        ...
        /// <summary>
        /// Returns contact information for the labeler of the device
        /// </summary>
        /// <value>Returns contact information for the labeler of the device</value>
        [DataMember(Name = "LabelerContactInfo", EmitDefaultValue = false)]
        public List<LabelerContact> LabelerContactInfo { get; set; }
        /// <summary>
        /// Returns the date the device record with the UDI was published in the GUDID (Global Unique Device Identifier Database); format: datetime
        /// </summary>
        /// <value>Returns the date the device record with the UDI was published in the GUDID (Global Unique Device Identifier Database); format: datetime</value>
        [DataMember(Name = "UDI_DIPublishDate", EmitDefaultValue = false)]
        public string UDIDIPublishDate { get; set; }
        /// <summary>
        /// Returns the date the device record was first published in the Prizm Medical Device Knowledge Base; format: datetime
        /// </summary>
        /// <value>Returns the date the device record was first published in the Prizm Medical Device Knowledge Base; format: datetime</value>
        [DataMember(Name = "PrizmPublishDate", EmitDefaultValue = false)]
        public string PrizmPublishDate { get; set; }
        /// <summary>
        /// Returns the last date the device record was updated and republished in the Prizm Medical Device Knowledge Base; format: datetime
        /// </summary>
        /// <value>Returns the last date the device record was updated and republished in the Prizm Medical Device Knowledge Base; format: datetime</value>
        ...
        /// <summary>
        /// Returns the HCPCS information for the device, if it is available and appropriate.
        /// </summary>
        /// <value>Returns the HCPCS information for the device, if it is available and appropriate.</value>
        ...
        /// <summary>
        /// Returns device properties such at materials, shapes, colors, etc.
        /// </summary>
        /// <value>Returns device properties such at materials, shapes, colors, etc.</value>
        [DataMember(Name = "DeviceProperties", EmitDefaultValue = false)]
        public List<DeviceProperty> DeviceProperties { get; set; }
        /// <summary>
        /// Returns a list of labeler aliases
        /// </summary>
        /// <value>Returns a list of labeler aliases</value>
        [DataMember(Name = "LabelerAliases", EmitDefaultValue = false)]
        public List<string> LabelerAliases { get; set; }
        /// <summary>
        /// Alternate device names
        /// </summary>
        /// <value>Alternate device names</value>
