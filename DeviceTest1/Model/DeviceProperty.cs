...
{
    /// <summary>
    /// Returns properties related to the device such at materials, shapes, colors, etc.
    /// </summary>
    [DataContract]
    public partial class DeviceProperty : IEquatable<DeviceProperty>
    {
        ...
        /// <param name="PropertyName">Returns the property name; e.g. color.</param>
        /// <param name="PropertyValue">Returns the property value; e.g. red.</param>
        /// <param name="SequenceNumber">Returns the sequence number of the property when multiple properties are listed.</param>
        ...
        /// <summary>
        /// Returns the property name; e.g. color
        /// </summary>
        /// <value>Returns the property name; e.g. color</value>
        [DataMember(Name = "PropertyName", EmitDefaultValue = false)]
        public string PropertyName { get; set; }
        /// <summary>
        /// Returns the property value; e.g. red
        /// </summary>
        /// <value>Returns the property value; e.g. red</value>
        [DataMember(Name = "PropertyValue", EmitDefaultValue = false)]
        public string PropertyValue { get; set; }
        /// <summary>
        /// Returns the sequence number of the property when multiple properties are listed
        /// </summary>
        /// <value>Returns the sequence number of the property when multiple properties are listed</value>
